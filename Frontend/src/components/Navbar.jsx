      ...
      <div className={`max-w-screen-2xl container mx-auto md:px-1 py-3 bg-slate-100 dark:bg-slate-700 dark:text-white fixed top-0 left-0 right-0 z-50 ${sticky ? "sticky-navbar shadow-md bg-base-300 duration-300 transition-all ease-in-out" : ""}`}>
        ...
        <div className="navbar ">
          <div className="navbar-start">
            ...
            <a className="btn btn-ghost text-4xl font-bold cursor-pointer">Chakri-Bakri</a>
          </div>
            ...
            <div className="navbar-end flex items-center gap-4 lg:gap-8">
              ...
              <div className='hidden md:block'>
                <label className="px-3 py-3 border rounded-md flex items-center gap-1">
                  <input type="text" className="grow outline-none px-2 py-1 border-3 rounded-md  dark:bg-slate-900 dark:text-white" placeholder="Search" />
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 16 16"
                    fill="currentColor"
              ...
              <div className="">
                <a className="btn bg-black text-white py-2 px-6 hover:bg-slate-600 duration-500 cursor-pointer" role="button"
                  tabIndex={0} onClick={() => document.getElementById("my_modal_company").showModal()}>Login as Company</a>
                <Login_Company />
              </div>
              <div className="">
                <a className="btn bg-black text-white py-2 px-6 hover:bg-slate-600 duration-500 cursor-pointer" role="button"
                  tabIndex={0} onClick={() => document.getElementById("my_modal_jobseeker").showModal()}>Login as Jobseeker</a>
                <Login_Jobseeker />
              </div>
            </div>
          </div>
